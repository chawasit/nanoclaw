...
export function renderAgentHomeManual(): string {
  return [
    ...
    '',
    "Read them at the start of a session; update them as you learn. If you want to remember",
    "something, write it to a file — mental notes don't survive a restart. Text beats brain.",
    '',
